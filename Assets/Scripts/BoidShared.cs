...
public class BoidShared : MonoBehaviour {
	...
	[Range (0f, 2f)] public float _TargetComponent = 1.5f;
	public static float TargetComponent = 0f;

	[Range (0f, 2f)] public float _ObstacleComponent = 2f;
	public static float ObstacleComponent = 0f;

	[Range (0f, 2f)] public float _WallComponent = 1.5f;
	public static float WallComponent = 0f;
	...
	private void OnValidate () {
		...
		ObstacleComponent = _ObstacleComponent;
